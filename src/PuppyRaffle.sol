...
contract PuppyRaffle is ERC721, ERC721Enumerable, Ownable {
    ...
    function enterRaffle(address[] memory newPlayers) public payable {
        // q where custom reverts a thing at 0.7.6 of Solidity?

        require(msg.value == entranceFee * newPlayers.length, "PuppyRaffle: Must send enough to enter raffle");
        for (uint256 i = 0; i < newPlayers.length; i++) {
            // q whats resets the players array?
    ...
    function selectWinner() external {
        ...
        // e why not just do address(this).balance?
        ...
        // q gas war ... // @followup @audit-looked-into people can revert the TX till they win
